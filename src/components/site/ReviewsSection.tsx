...
export function ReviewsSection() {
  ...
  const items = reviews.length
    ? reviews.map((r) => ({ id: r.id, name: r.level ? `${r.author}, ${r.level}` : r.author, text: r.text, photo: r.photo }))
    : FALLBACK_REVIEWS.map((r) => ({ id: r.name.en, name: r.name[lang], text: r.text[lang], photo: undefined as string | undefined }));
  return (
