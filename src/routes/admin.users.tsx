    ...
    <>
            ...
            <div key={u.id} className="flex flex-wrap items-center justify-between gap-3 py-4">
              ...
              <div className="flex items-center gap-2">
                <Badge tone={u.status === "active" ? "green" : "amber"}>
                  {u.status === "active" ? "Активен" : "Приглашён"}
                </Badge>
      ...
      <Modal open={inviting} onClose={() => setInviting(false)} title="Приглашение по почте">
        <div className="space-y-4">
          ...
          <Field
            label="Роль"
            hint="Роль назначается заранее — приглашённый сразу получит нужные права"
          >
            <Select
              value={draft.role}
          ...
          <p className="text-xs text-[oklch(0.6_0.03_45)]">
            Логин и пароль передайте пользователю — он сразу сможет войти в панель.
          </p>
        </div>
      </Modal>
    </>
